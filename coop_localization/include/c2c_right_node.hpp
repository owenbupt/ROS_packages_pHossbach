#ifndef C2C_RIGHT_Node_HPP
#define C2C_RIGHT_Node_HPP
...
private:
	...
	tf::StampedTransform steady_transform = tf::StampedTransform(tf::Transform::getIdentity(), ros::Time::now(), "a_center", "c2c_right");

	// changeable parameters
	string side = "right";
	double filter_change_rate = 1;		// see C2C_RIGHT_Node::stampedTF_filter
	double weight_of_center = 0.8;			// see C2C_RIGHT_Node::merge_msgsToTF
