...
C2C_LEFT_Node::C2C_LEFT_Node()
{
	transform_sub = nh.subscribe ("/multi_boards_vrm_" + side + "/transform", 1, &C2C_LEFT_Node::arsys_transform_callback, this);
...
void C2C_LEFT_Node::arsys_transform_callback (const geometry_msgs::TransformStamped& transformMsg)
{
...
tf::StampedTransform C2C_LEFT_Node::merge_msgsToTF(const geometry_msgs::TransformStamped& msg1, const geometry_msgs::TransformStamped& msg2)
{
...
// [ A(front), B(right), C(back) or D(left) ]
tf::StampedTransform C2C_LEFT_Node::choose_c2c()
{
...
tf::StampedTransform& C2C_LEFT_Node::stampedTF_filter(tf::StampedTransform &steady, const tf::StampedTransform &fresh)
{
...
void C2C_LEFT_Node::read_robotModel_input()
{
		float tf_data[14];
